...
class _$RegisterResponseImpl implements _RegisterResponse {
  ...
  @override
  String toString() {
    return 'RegisterResponse(message: $message, userData: $userData, status: $status, code: $code)';
  }
...
abstract class _RegisterResponse implements RegisterResponse {
  const factory _RegisterResponse(
      {final String? message,
      @JsonKey(name: 'data') final UserData? userData,
      final bool? status,
      final int? code}) = _$RegisterResponseImpl;
